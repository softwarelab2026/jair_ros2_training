...
def test_turtle_middle_ball_in_front(turtle_pos: Pose):
    ...
    angle, dist = calc_turtle_error(ball_pos[0], ball_pos[1], turtle_pos.x, turtle_pos.y, turtle_pos.theta)
...
def test_turtle_middle_ball_in_front_left(turtle_pos: Pose):
    ...
    angle, _ = calc_turtle_error(ball_pos[0], ball_pos[1], turtle_pos.x, turtle_pos.y, turtle_pos.theta)
...
def test_turtle_right_down_looking_up_ball_left_behind():
    turtle_pos = Pose(x=5.0 ,y=5.0, theta=0.0)
    ball_pos = 4, 4
